...
\begin{tikzpicture}
    ...
    major grid style={line width=.2pt,draw=gray!50}
     ...
     \addplot[color=black,dashed, name path=right]{x};  
      ...
      \addplot[color=orange, opacity=0.5, samples=10,domain=0:0.435]{-2.5*x};
      %  %  %  %  %  %  %  %  %  % ingoing
      \addplot[color=yellow!90!black, very thick ,samples=10, domain=-1.517:8]{-x+0.3};
      \addplot[color=yellow!90!black, very thick ,samples=10, domain=-0.106:8]{-x+0.9};
      \addplot[color=yellow!90!black, very thick ,samples=10, domain=0.622:8]{-x+1.8};
      \addplot[color=yellow!90!black, very thick ,samples=10, domain=1.333:8]{-x+3}; 
      \addplot[color=yellow!90!black, very thick ,samples=10, domain=2.139:8,opacity=0.8]{-x+4.5};
      \addplot[color=yellow!90!black, very thick ,samples=10, domain=3.173:8,opacity=0.7,dashed]{-x+6.5};
      \addplot[color=amethyst!90, very thick ,samples=10, domain=-8:0.1]{x+0.9};
      \addplot[color=amethyst!90, very thick ,samples=10, domain=-8:-0.75]{x+2};
      \addplot[color=amethyst!90, very thick ,samples=10, domain=-8:-1.333]{x+3};
      \addplot[color=amethyst!90, very thick ,samples=10, domain=-8:-1.875]{x+4};
    \end{axis}
\end{tikzpicture} 
\end{document}